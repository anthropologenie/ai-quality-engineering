...
**16 capabilities.** Eight reassigned from Milestone 1A by `docs/P3.7.3_…` Decision 5; eight affirmed here without ever having been Milestone 1A obligations. **Eight are discharged and retained here with their discharge recorded**, per §1.3 (*a capability is never deleted*) — **1B-08** and **1B-09** by Sprint 1B.1; **1B-01**, **1B-02**, **1B-03**, **1B-04** and **1B-10** by Sprint 1B.2; and **1B-11** by Sprint 1B.2B, under Repository Owner ruling **R-02**. The count is unchanged for that reason: it counts capabilities allocated, not capabilities outstanding.
